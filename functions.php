...
//add image sizes
 add_image_size( 'blog-astra-crop', 400, 250, array( 'center', 'center' ) );
...
add_action( 'astra_entry_top', 'add_breadcrumbs_content_top' );
function add_breadcrumbs_content_top() {
...
add_filter( 'gform_incomplete_submissions_expiration_days', 'extend_gfroms_expiration_days', 10, 1 );

function extend_gfroms_expiration_days( $expiration_days ) {
    $expiration_days = 180;
